  ...
  <!-- Modal -->
<div class="modal fade" id="Fotografia" tabindex="-1" aria-labelledby="FotografiaLabel" aria-hidden="true">
        ...
        <div class="modal-content bg-azul-3 modal-tuto">
            <div class="modal-body bg-continente">
                ...
                <div class="text-center mb-5">
                    <h1 class="titulos text-white bold">Ejemplo de fotografía a subir</h1>
                </div>
                <div class="container my-5">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-4">
                            ...
                            <div class="">
                                ...
                                <h6 class="regular top-menu text-white"><i class="fa-solid fa-check txt-verde"></i> Fondo blanco</h6>
                                <h6 class="regular top-menu text-white"><i class="fa-solid fa-check txt-verde"></i> Buena iluminación</h6>
                                <h6 class="regular top-menu text-white"><i class="fa-solid fa-check txt-verde"></i> De frente</h6>
                                <h6 class="regular top-menu text-white"><i class="fa-solid fa-check txt-verde"></i> Horizontal</h6>
                                <h6 class="regular top-menu text-white"><i class="fa-solid fa-check txt-verde"></i> Del pecho hacia arriba</h6>
                            </div>
                        </div>
                    ...
                    <div class="row txt-evitar pt-5">
                        <div class="text-center mb-4">
                            <h6 class="bold h5 text-white">Evitar el uso de:</h6>
                        </div>
                        <div class="col-12 col-sm-12 col-md-12 col-lg-4">
                            <div class="text-center">
