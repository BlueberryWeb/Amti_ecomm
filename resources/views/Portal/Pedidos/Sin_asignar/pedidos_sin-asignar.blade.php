<x-app-layout>
    ...
    <div class="row align-items-start">
        <div class="col-9">
            <h2 class="display-6"> <b style="color: #163B5B"> Pedidos SIN asignar:</b> </h2>
        </div>
    </div>
    <hr>
                        ...
                        <tr class="text-white" style="background-color: #163B5B">
                            <th>
                                <input style="border: solid #163B5B 0.5px" type="text"
                                    class="form-control form-control-sm filter-input " placeholder="Pedido..."
                                    data-column="1">
                            </th>
                            <th>
                                <input style="border: solid #163B5B 0.5px" type="text"
                            ...
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="{{ route('portal.pedidos.detalles', $pedido->id) }}"
                                        ...
                                        data-bs-toggle="tooltip" data-bs-placement="top" title="Gestionar">
                                    ...
                                    <button type="button"
                                        ...
                                        data-bs-toggle="modal" data-bs-placement="top" title="Comentarios"
                                        data-bs-target="#NotasPedido-{{ $pedido->id }}">
                                    ...
                                    <button type="button"
                                        ...
                                        data-bs-toggle="modal" data-bs-placement="top" title="Asignar"
                                        data-bs-target="#asignarVendedor">
